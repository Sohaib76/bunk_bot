...
x7,y7,x8,y8,x9,y9,x10,y10,x11,y11,x12,y12,x13,y13,x14,y14,x15,y15=263, 281 ,979, 410 ,859 ,512,406, 578, 507, 604, 972, 425, 1120, 92 ,1060 ,683,474 ,682#open google meet
x17, y17, x18, y18, x19, y19 = 1282 ,154, 1092 ,685, 1340 ,693#cordinates to type on the chat box
...
if __name__ == "__main__":
    ...
    #Downloading Meet Link using Google Classroom
    ...
    #Getting Link , Different Methods
    # fp = open(filelocation,"r+")
    # link=fp.readline()
    # link = input("Enter Link: ")
    link = "meet.google.com/ztw-iotj-qjm"

    # navToMeetTillChatOpen()
    ...
    r = sr.Recognizer()
    print("Voice Recognition For Listening To Teacher's attendance call")
    while(clock()!=60):     
        ...
        try: 
            ...
            with sr.Microphone() as source2: 
                ...
                if(MyText.find("fifty one")!=-1 or MyText.find("51")!=-1 or  MyText.find("seventeen zero five one")!=-1 or  MyText.find("17051")!=-1):
